...
<a class=" nav-item nav-link " href="acceso.php"><button class="btn btn-lg  btn-success active">Admin</button></a>
   ...
   <div class="row my-5">
                ...
                <div class="col-sm-5 offset-sm-4 text-center bg-success" ">
                    <h1 class="chewy display-3">Accede</h1>
                    <h4 class="chewy ">Escribe Tus Credenciales </h3>
                    <br>

                    <div class="info-form">
                        <form action="#" method="POST" class="form-control-success justify-content-center" >
                            ...
                            <div class="form-group mx-5 chewy col-auto">
                                <input name="correo" type="password" class="form-control" placeholder="Contraseña">
                            </div>
                               
                            <button type="submit" class="btn btn-success btn-lg chewy"><a style="text-decoration: none; color: white;" href="formulario.php">Suscribir</a></button>

                               
                            <button type="submit" class="btn btn-success btn-lg chewy">Acceder</button>
                        </form>
                    </div>
                    <br>
